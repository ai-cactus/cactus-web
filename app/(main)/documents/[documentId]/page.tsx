...
function Document() {
  ...
  const typeDocumentId = documentId as string | undefined;
  ...
  const { data: document } = useGetDocumentById(typeDocumentId);
    ...
    <div className="relative">
      <div className="mr-[355px] relative min-h-full p-4 pt-0">
        ...
        <div>
          ...
          {document ? <PlateEditor sections={document.sections} /> : null}
        </div>
      </div>
      {/* <EditorSidebar
