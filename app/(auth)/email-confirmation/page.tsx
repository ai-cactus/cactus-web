...
function page() {
  return (
    <div className="flex flex-col px-10 py-10 min-h-screen justify-center">
      <Image
      ...
      <h2 className="text-2xl font-bold text-center my-2">
        Welcome to Theraptly
      </h2>
      <p className="mb-7 text-center">
        Click the button below to confirm your email address and start using
        your account.
      </p>
